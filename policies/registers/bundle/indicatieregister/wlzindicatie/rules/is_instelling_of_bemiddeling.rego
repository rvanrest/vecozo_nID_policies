...
is_instelling_of_bemiddeling if {
	agb_pip_required
	...
	bemiddelingsregister_pip.is_instelling_of_bemiddeling_by_wlz_indicatie_id(wlz_indicatie_id)
}
...
error_messages contains msg if {
	...
	subject_is_instelling
	id_is_required
	not is_instelling_of_bemiddeling

	msg := {
		"message": common.err("Subject is not listed as `instelling` of a bemiddeling with the specified `wlzindicatieID`", config.operation), # regal ignore:line-length
